...
| --- | --- | --- | --- | --- |
| Basaltwater identity and rename | Core namespace delivered; storage identity cutover and release qualification pending | Unscheduled | No dedicated issue | [Basaltwater rename](BASALTWATER_RENAME.md): core source/runtime rename, recent-install migration, documentation, skills and visual identity delivered; [storage identity cutover](BASALTWATER_CONTRACTS.md#outstanding-storage-identity-cutover) remains; [release checklist](../BASALTWATER_RELEASE.md) tracks live VM qualification and external publication. |
