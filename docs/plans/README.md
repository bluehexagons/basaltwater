...
| CachyOS agentic desktop capabilities | Proposed; no machine-use automation shipped; live Wayland qualification required | Unscheduled | No dedicated issue | [CachyOS agentic desktop](CACHYOS_AGENTIC_DESKTOP.md): qualify native browser, AT-SPI, and portal capabilities behind opt-in flags, then add application readiness, maintenance, and collaboration slices. |
